...
--
-- Host: localhost    Database: insuranceappdb
-- ------------------------------------------------------
...
CREATE TABLE `userrole` (
  ...
  KEY `UserID` (`UserID`),
  KEY `RoleID` (`RoleID`),
  CONSTRAINT `userrole_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `userdetails_tbl` (`userid`),
...
-- Dump completed on 2022-02-11 16:42:01
